...
class Main extends PluginBase implements Listener {
    ...
    public function forceHub(PlayerLoginEvent $event){
        if ($this->config["forcehub"] === "true"){
        	$event->getPlayer()->teleport($this->getServer()->getDefaultLevel()->getSafeHub());
   	 }
    }
}
